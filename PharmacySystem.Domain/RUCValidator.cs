...
{
    // Check-digit validation for Ecuadorian identification numbers (cedula and RUC).
    // Pure domain logic: it lives here rather than next to the UI rule table in Validations.cs
    // so it can be referenced without dragging in any presentation concern.
